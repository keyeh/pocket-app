    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <FormInput onChangeText={this._handlePasswordChange} secureTextEntry value={formPassword} />
                <Button title={authLoading ? "Loading" : "Sign In"} onPress={this._handleNextButtonPress} style={styles.nextButton} />
